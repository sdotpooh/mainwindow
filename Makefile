...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Nov 18 00:22:07 2013
...
SOURCES       = ControlPanel.cpp \
		...
		main.cpp \
		mainwindow.cpp \
		TesseraParameters.cpp moc_ControlPanel.cpp \
		moc_ImageWindow.cpp \
		moc_mainwindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mainwindow1.0.0/ && $(COPY_FILE) --parents ControlPanel.h Globals.h HSL.h ImageWindow.h mainwindow.h TesseraParameters.h .tmp/mainwindow1.0.0/ && $(COPY_FILE) --parents ControlPanel.cpp HSL.cpp ImageWindow.cpp main.cpp mainwindow.cpp TesseraParameters.cpp .tmp/mainwindow1.0.0/ && (cd `dirname .tmp/mainwindow1.0.0` && $(TAR) mainwindow1.0.0.tar mainwindow1.0.0 && $(COMPRESS) mainwindow1.0.0.tar) && $(MOVE) `dirname .tmp/mainwindow1.0.0`/mainwindow1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mainwindow1.0.0
...
compiler_moc_header_make_all: moc_ControlPanel.cpp moc_ImageWindow.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ControlPanel.cpp moc_ImageWindow.cpp moc_mainwindow.cpp
moc_ControlPanel.cpp: TesseraParameters.h \
		ControlPanel.h
	/usr/bin/moc $(DEFINES) $(INCPATH) ControlPanel.h -o moc_ControlPanel.cpp

moc_ImageWindow.cpp: ImageWindow.h
	/usr/bin/moc $(DEFINES) $(INCPATH) ImageWindow.h -o moc_ImageWindow.cpp

moc_mainwindow.cpp: TesseraParameters.h \
		ControlPanel.h \
		ImageWindow.h \
		mainwindow.h
...
HSL.o: HSL.cpp HSL.h \
		Globals.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HSL.o HSL.cpp
...
TesseraParameters.o: TesseraParameters.cpp TesseraParameters.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TesseraParameters.o TesseraParameters.cpp
