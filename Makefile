...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Sun Dec 1 19:40:35 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mainwindow1.0.0/ && $(COPY_FILE) --parents ControlPanel.h Globals.h HSL.h ImageWindow.h mainwindow.h TesseraParameters.h Tree.h .tmp/mainwindow1.0.0/ && $(COPY_FILE) --parents ControlPanel.cpp HSL.cpp ImageWindow.cpp main.cpp mainwindow.cpp TesseraParameters.cpp Tree.cpp .tmp/mainwindow1.0.0/ && (cd `dirname .tmp/mainwindow1.0.0` && $(TAR) mainwindow1.0.0.tar mainwindow1.0.0 && $(COMPRESS) mainwindow1.0.0.tar) && $(MOVE) `dirname .tmp/mainwindow1.0.0`/mainwindow1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mainwindow1.0.0
...
moc_mainwindow.cpp: ControlPanel.h \
		TesseraParameters.h \
		ImageWindow.h \
		mainwindow.h
